...
module.exports = {
    ...
    LM_STUDIO_UNLOAD_MODEL_URL: process.env.LM_STUDIO_UNLOAD_MODEL_URL || `${LM_STUDIO_BASE_URL}/api/v1/models/unload`,
    ...
    LM_STUDIO_MAX_TOKENS: readInt('LM_STUDIO_MAX_TOKENS', 2048, 1),
